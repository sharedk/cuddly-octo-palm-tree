...
public class SpringAppDemoApplicationConfig {
    ...
    CommandLineRunner commandlineRunner(StudentRepository studentRepository,SchoolRepository schoolRepository){
        return args -> {
            ...
            Student cosimo = new Student("cosimo", LocalDate.of(1995,Month.DECEMBER,27), "cosimo.moretti@outlook.it",school1);
            Student mariam = new Student("mariam",LocalDate.of(1995,Month.APRIL,8),"mariam@gmail.com",school1);
